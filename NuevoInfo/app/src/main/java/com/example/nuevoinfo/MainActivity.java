        ...
        btn_guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(txt_nombres.getText().toString().equals("")|| txt_correo.getText().toString().equals("")
                    ...
                    String selectedItem = cbx_lista.getSelectedItem().toString();

                    Intent intent = new Intent(MainActivity.this,GraudarActivity.class);
                    ...
                    intent.putExtra("cbx_lista", selectedItem);
